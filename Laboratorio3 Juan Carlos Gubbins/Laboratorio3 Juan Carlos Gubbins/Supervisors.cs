...
namespace Laboratorio3_Juan_Carlos_Gubbins
{
    class Supervisors : Person
    {
        ...
        public Supervisors(string _rut_, string _nombre_, string _apellido_, string _nacimiento_, string _nacionalidad_,int _sueldo_,string _horario_)
